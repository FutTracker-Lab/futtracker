...
// separados — decisión documentada en el comentario de FUT-84 (2026-08-26):
// el kit de diseño ya construye la pantalla así (ScreenAuth), y es el mismo
// destino al que redirige el middleware (proxy.ts) cuando no hay sesión.
